/*
 * Bootstrap Extension v5.3.2 (https://bootstrapextensions.com)
...
//                    event.preventDefault();
                    if (hp && getComputedStyle(hp).getPropertyValue('display') === 'flex') {
                        ...
                        var posY = document.querySelector(menuItem.getAttribute('href').substring(menuItem.getAttribute('href').indexOf('#'))).offsetLeft - offset;
                    } else {
